...
import webmarker.adapter.servlet.matchers.Or;
import webmarker.adapter.servlet.matchers.PathInfo;
import webmarker.adapter.servlet.resource.ServletResourceLoader;
...
public class WebMarkerServlet extends HttpServlet {

	private static final long serialVersionUID = 1L;

    private static Logger logger = LoggerFactory.getLogger(WebMarkerServlet.class);
